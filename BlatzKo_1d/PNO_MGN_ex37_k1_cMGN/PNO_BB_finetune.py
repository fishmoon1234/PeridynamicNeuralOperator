...
def main():
    ...
    for index in range(4):
        ...
        trained_model = 'Results/%s_%s_ntrain_%s_lrs_[0.01]_lr_[0.995, 0.998]_gap_%s' % (ex, layer_info, ntrain, gap)
        ...
        base_dir = 'Results/%s_ft_%s_ntrain_%s_lrs_%s_lr_%s_gap_%s' % (ex, layer_info, ntrain, lrs, lr, gap)
