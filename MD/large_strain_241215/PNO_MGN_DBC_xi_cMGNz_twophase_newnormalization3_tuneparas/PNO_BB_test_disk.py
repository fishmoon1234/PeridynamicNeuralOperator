...
def main():
    ...
    base_dir = '%s/Results/MD_index_274_nvalid50_16_16_256_4_lr0.001_dr0.5_step100_bs10_norm1_z_beta50.0' % current_dir

            
    model_path = os.path.join(base_dir, 'model_16.ckpt')
