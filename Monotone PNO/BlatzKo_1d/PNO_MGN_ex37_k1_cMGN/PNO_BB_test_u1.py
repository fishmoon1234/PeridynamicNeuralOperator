...
# DATA_NAME = 'BK_%s_ndata_100_Nx_257_delta_0.25_h_0.00390625_0.0015' % (ex_data)
# DATA_NAME = 'BK_%s_ndata_1_Nx_257_delta_0.25_h_0.00390625_case1' % (ex_data)
...
### load trained model ###
base_dir = 'Results/ex33_128_5_ntrain_300_lrs_[0.01]_lr_[0.995, 0.998]_gap_1'
...
# plot_index = [28,43,47, 57,74,92]  
# plot_index = [3, 17, 36, 41]   
compute, plot = 1, 1
if compute == 1:
    ...
    with torch.no_grad():
        ...
        # for j in plot_index:
            ...
            def func(u):
                ...
                # y = model(data)-data.f.squeeze()
                return y.cpu().detach().numpy()
            
            if initial_type == 'linear':
