...
class DenseNet(nn.Module):
    def __init__(self, phi_1_layer, act_fn=nn.Softplus()):
        ...
        self.layers.append(nn.Linear(phi_width, phi_in))
...
class E_GCL_GKN(nn.Module):
    ...
    def __init__(self, phi_2_layer, act_fun_xi, act_fn=nn.Sigmoid(), normalize=False,
    ...
    def forward(self, data):
        ...
        phi_NN2 = self.phi_2(ksi_norm.reshape(-1,1)+1e-9).reshape(-1,n_ksi)
