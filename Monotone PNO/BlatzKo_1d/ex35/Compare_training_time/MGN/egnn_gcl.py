...
class E_GCL_GKN(nn.Module):
    ...
    def forward(self, data):
        ...
        phi_NN1_tol = self.phi_MGN((tol * torch.ones_like(lambdaa)).reshape(-1,1)).reshape(-1,n_ksi)
        ...
        phi_NN_normal = (phi_NN1 - phi_NN1_1) * phi_NN2
        phi_NN_tol = (phi_NN1_tol - phi_NN1_1) * phi_NN2
        phi_NN = torch.where(lambdaa < tol, phi_NN_tol, phi_NN_normal)
