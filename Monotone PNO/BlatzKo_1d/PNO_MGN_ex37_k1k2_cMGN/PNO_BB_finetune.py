...
def main():
    ...
    lr_all = [0.996, 0.996, 0.999, 0.998]
    for index in range(3,4):
        ...
        # layer_info = '128_5_256_5'
        # phi_1_layer = [1, 128, 128, 128, 128, 128, 1]
        # phi_2_layer = [1, 256, 256, 256, 256, 256, 1]
        # layer_info = '256_5_256_5'
        # phi_1_layer = [1, 256, 256, 256, 256, 256, 1]
        # phi_2_layer = [1, 256, 256, 256, 256, 256, 1]
        # layer_info = '256_5_128_5'
        # phi_1_layer = [1, 256, 256, 256, 256, 256,  1]
        # phi_2_layer = [1, 128, 128, 128, 128, 128, 1]
        act_xi = 'ReLU'
        # act_xi = 'GELU'
        ...
        trained_model = '%s/Results/ex32_128_5_256_4_ntrain_300_lrs_[0.005]_lr[0.997, 0.999]_gap_1' % (current_dir)
            ...
            for learning_rate in lrs:
                for scheduler_gamma in gammas:
                    for weight_decay in wds:
                        ...
                        base_dir = 'Results/%s_%s_ntrain_%s_lrs_%s_lr%s_gap_%s' % (ex, layer_info, ntrain, learning_rate, lr, gap)
