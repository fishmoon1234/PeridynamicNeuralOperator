...
# start_layer = 8
# layer_add_times = 2
model = E_GCL_GKN(num_layers, embed_dim, phi_2_layer, nn.ReLU(), nn.Sigmoid()).to(device)

# ex_data = 'ex37'
# ex_data = 'ex37_sample'
ex_data = 'ex37_sample_10'
# ex_data = 'ex37_sample_largestrain'
