...
model_NN_path = '%s/Results/ex35_128_5_ntrain_300_lrs_[0.01]_lr_[0.99, 0.998]_gap_1' % current_dir
...
print(f"Total number of parameters: {total_params}")
model_MGN_path = '%s/../PNO_MGN_ex35_k1/Results/ex35_128_5_ntrain_300_lrs_[0.01]_lr_[0.99, 0.998]_gap_1' % current_dir
...
model_ICNN_path = '%s/../PNO_ICNN_ex35_k1/Results/ex35_128_5_ntrain_300_lrs_[0.01]_lr_[0.99, 0.998]_gap_1' % current_dir
